...
**Core Responsibility:** Candidate pipeline, job requisitions

**Key Aggregates:** JobRequisition, Candidate, Interview

**Emits Events:** `candidate.hired`, `interview.scheduled`
